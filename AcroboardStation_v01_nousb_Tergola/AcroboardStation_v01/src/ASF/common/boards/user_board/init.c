...
void board_init(void)
{
	...
	/////////////////////////////////////////////////////////////
	// SENSORCODE: sensors' serial port configuration
	//Configure the UART on PortC
	ioport_configure_pin(SENSIT_USART_TX, IOPORT_DIR_OUTPUT | IOPORT_INIT_HIGH);
	ioport_configure_pin(SENSIT_USART_RX, IOPORT_DIR_INPUT);
	ioport_configure_pin(SENSIT_USART_TX_ENABLE, IOPORT_DIR_OUTPUT | IOPORT_INIT_HIGH);
	ioport_configure_pin(SENSIT_USART_2_TX, IOPORT_DIR_OUTPUT | IOPORT_INIT_HIGH);
	ioport_configure_pin(SENSIT_USART_2_RX, IOPORT_DIR_INPUT);
	ioport_configure_pin(SENSIT_USART_2_TX_ENABLE, IOPORT_DIR_OUTPUT | IOPORT_INIT_HIGH);
	/////////////////////////////////////////////////////////////
}
